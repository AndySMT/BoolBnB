...
function ChatBot({ propertyId }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        setMessages([...newMessages, { role: 'ai', content: 'Sorry, I could not process your request.' }]);
      }
    } catch (error) {
  ...
  return (
    <div className="md:block">
      ...
      {isOpen && (
        <div className="fixed bottom-[8rem] md:bottom-[calc(4rem+1.5rem)] right-0 mr-4 bg-white p-6 rounded-lg border border-[#e5e7eb] w-[440px] h-[634px] shadow-sm">
