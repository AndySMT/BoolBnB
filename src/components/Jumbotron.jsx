    ...
    >
      ...
      >
        ...
        <p className="font-black tracking-wide text-xl text-stone-700 md:text-2xl">
          From cozy cottages to luxurious villas, discover the ideal space for
          your next adventure
        </p>
      </div>
      <div
      ...
      >
        <div className="font-semibold lg:font-light lg:text-base">
          <span>
            <span className="underline underline-offset-2">Already Know</span>{" "}
            What You're Looking For? <br />
            Your <strong className="font-semibold">Dream</strong> Stay is Just{" "}
            <strong className="font-semibold">One Click Away</strong>!
          </span>
        </div>
  ...
  return (
    <div className="hidden lg:grid grid-cols-2 grid-rows-2 h-full">
      {imageAnimations.map((animation, index) => (
        <motion.div
          key={index}
          style={{ scale: parseFloat((baseScale + index * 15) / 100) }}
