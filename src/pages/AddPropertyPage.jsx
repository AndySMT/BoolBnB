...
function HeroSection({ setIsFormOpen }) {
  ...
  return (
    <section className="container mx-auto p-4 md:p-10">
      <div className="gap-10 flex flex-col md:flex-row mt-10 justify-center items-center p-4 md:p-10 rounded-lg">
        {/* Testo */}
        <div className="text-center md:text-left md:w-1/2">
          <h1 className=" text-gray-700 text-4xl font-bold leading-tight text-center">
            Apri il tuo <span className="text-red-600">BoolBnB</span>
            <br />
            potresti <br />
            guadagnare <br />
            fino a <br />
            <span className="text-black">{(range * 56.12).toFixed(2)}€</span>
          </h1>
          {/* <p className="text-gray-700 mt-3">
            Guadagna ospitando viaggiatori da tutto il mondo. Mettere in affitto
            la tua casa è facile e sicuro.
          </p> */}
          <div className="flex flex-col items-center md:items-start mt-5 relative">
            ...
            <div className="relative w-full">
              ...
              <input
                type="range"
                className="mt-5 w-full cursor-pointer custom-range"
                min={1}
                max={30}
                value={range}
      ...
      <style>{`
        ...
        .custom-range::-webkit-slider-thumb {
          ...
          width: 20px;
          height: 20px;
          background: #000000;                /* Colore del thumb */
          border-radius: 50%;
          cursor: pointer;
...
function InfoSection() {
  return (
    <section className="grid grid-cols-1 md:grid-cols-2 justify-center items-center p-4 md:p-10 rounded-lg w-auto max-h-fit">
      ...
      <div className="p-4 md:p-6">
        ...
        <p>
          ...
          cumque labore facilis ipsam illum assumenda quidem nisi? Pariatur,
          excepturi. Omnis ipsam autem officia dolor perferendis. Reiciendis aut
          cumque earum molestias nulla eveniet id corrupti quis sunt nihil
          laudantium blanditiis sint enim, quo omnis dicta esse! Facere
          voluptates cupiditate veniam sapiente, porro eligendi, exercitationem
          soluta esse, asperiores enim quae ipsum repudiandae eos. Nemo, opti
        </p>
      </div>
    </section>
  );
