    ...
    return (
        <section className="gap-8 grid grid-cols-1 md:grid-cols-2 p-8 sm:p-12 lg:px-24">
            ...
            <p className="md:col-span-2">
                ...
                Pariatur cumque labore facilis ipsam illum assumenda quidem
                nisi? Pariatur, excepturi. Omnis ipsam autem officia dolor
                perferendis. Reiciendis aut cumque earum molestias nulla eveniet
                id corrupti quis sunt nihil laudantium blanditiis sint enim, quo
                omnis dicta esse! Facere voluptates cupiditate veniam sapiente,
                porro eligendi, exercitationem soluta esse, asperiores enim quae
                ipsum repudiandae eos. Nemo, opti
            </p>
        </section>
    );
}
        ...
        <section className="p-8 sm:p-12 lg:px-24">
            <div className="text-center mb-6">
                <h1 className="text-2xl md:text-3xl font-bold text-gray-900">
                    Pubblica il tuo annuncio con BoolBnB e approfitta dei nostri
                    servizi
                </h1>
            </div>
                ...
                <table className="w-full border-collapse">
                    ...
                    <tbody>
                        {[
                            ...
                            {
                                servizio:
                                    "Protezione danni fino a 3.000.000 USD",
                                boolbnb: true,
                                competitors: false,
                            },
                            {
                            ...
                            {
                                servizio:
                                    "Danni causati dagli animali domestici",
                                boolbnb: true,
                                competitors: false,
                            },
                            {
