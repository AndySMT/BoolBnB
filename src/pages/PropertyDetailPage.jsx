                    ...
                    <section className="flex flex-col sm:flex-row justify-between gap-4">
                        ...
                        <div className="md:w-1/2 space-y-2">
                            ...
                            <div className="my-6">
                                ...
                                adipisicing elit. Id, error in ipsum voluptate
                                placeat ea sequi, sint eos vel natus nemo minus
                                optio eius enim dolorum dolorem. Officia beatae
                                laboriosam ratione eveniet perferendis suscipit
                                delectus aliquid? Eos ut dolorum cumque esse,
                                nesciunt, repellendus iusto vel, rerum aliquid
                                quos atque voluptates.
                            </div>
                        </div>
                        {/* Contact Form */}
                        <PaginaContact />
                ...
                <section className="px-3 sm:px-6 lg:px-12 xl:px-20 m-2 sm:m-6 lg:mx-20 mb-0 pb-6 ">
                    ...
                    <form onSubmit={handleReviewSubmit}>
                        ...
                        <textarea
                            ...
                            onChange={handleInputChange}
                        />
                        <div className="flex flex-row-reverse gap-2 justify-between whitespace-nowrap items-center">
                            <button
                                type="submit"
                            ...
                            {formError && (
                                <div className="flex flex-wrap gap-1 items-center justify-center py-1 px-2 sm:px-4 rounded-lg text-base font-medium [transition:all_0.5s_ease] border-solid border border-[#f85149] text-[#b22b2b] [&_svg]:text-[#b22b2b] group bg-[linear-gradient(#f851491a,#f851491a)]">
                                    <svg
                                        stroke="currentColor"
                                        fill="none"
                                        stroke-width="2"
